        ...
        <div className="row justify-content-center">
          <div className="col-lg-10">
            <div className="container section-title" data-aos="fade-up">
              ...
              <p
                className="fees-para"
                style={{ fontSize: "18px", paddingTop: "1rem" }}
              >
                We aim to provide a fair and efficient service for all our
                patients. To facilitate this, the practice has adopted a policy
                that all accounts should be settled at the time of your
                consultation. We thank all our patients for co-operating with
                this policy.
              </p>
              <p
                className="fees-para"
                style={{ fontSize: "18px", textAlign: "start !important" }}
              >
                If you have an outstanding balance, you may receive an SMS
                message from us with a secure payment link. Patients with
                outstanding balances are advised to pay their balance in full
                prior to making any further appointments.
              </p>
              <p className="fees-para" style={{ fontSize: "18px" }}>
                We accept payment by cash, card or cheque and can take payment
                online or over the phone on outstanding balances.
              </p>
              <p
                className="fees-para"
                style={{ fontSize: "18px", paddingBottom: "1rem" }}
              >
                You can see an outline of our general fees below, please note
                that the fee for consultation with the Nurse may vary depending
                on the service being provided. Please enquire at reception if
                the fee for a particular service is not available below.
              </p>
            </div>
              ...
              <div className="row">
                <div className="col-md-6 mb-4 d-flex">
                  <table className="table table-bordered flex-fill">
                    <thead
                      style={{ backgroundColor: "#3fbbc0", color: "white" }}
                    >
                      <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          Consultation 2 members (1 adult + 1 u 12's exc u 6)
                        </td>
                        <td>€100.00</td>
                      </tr>
                      <tr>
                ...
                <div className="col-md-6 mb-4 d-flex">
                  <table className="table table-bordered flex-fill">
                    <thead
                      style={{ backgroundColor: "#2c9faf", color: "white" }}
                    >
                      <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Capacity Assessment Repeat</td>
                        <td>€125.00</td>
                      </tr>
                      <tr>
                ...
                <div className="col-md-6 mb-4 d-flex">
                  <table className="table table-bordered flex-fill">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          Mirena|Copper Coil Removal & Insertion (same day)
                        </td>
                        <td>€200.00</td>
                      </tr>
                      <tr>
            ...
            <div className="alert alert-info mt-4">
              ...
              <p>
                Patients with a valid Medical Card (Full or GP Visit) can access
                many free medical services, but note that some services are not
                fully covered:
              </p>
              <div className="row">
              ...
              <p className="mb-0">
                <strong>
                  If unsure whether a service incurs a charge, please call the
                  surgery before your appointment.
                </strong>
              </p>
            </div>
          </div>
