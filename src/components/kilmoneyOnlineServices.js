...
export default function KilmoneyOnlineServices() {
    ...
    : "Request Now"}
      ...
      {activeForm === "letter" && (
        <Modal onClose={closeForm}>
          <LetterRequestForm onClose={closeForm} clinicLocation="Kilmoney Clinic" />
        </Modal>
      )}
      {activeForm === "results" && (
        <Modal onClose={closeForm}>
          <TestResultsForm onClose={closeForm} clinicLocation="Kilmoney Clinic" />
        </Modal>
      )}
      {activeForm === "illness" && (
        <Modal onClose={closeForm}>
          <IllnessForm onClose={closeForm} clinicLocation="Kilmoney Clinic" />
        </Modal>
      )}
    </>
  )
